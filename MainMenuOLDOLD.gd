...
func _ready():
	...
	videoIntro = preload("res://VIDEOS/Astro_Menu_Art_Update_intro.ogv")#preload("res://VIDEOS/Astro_Menu_Art_INTRO-C.ogv")
	videoMenu = preload("res://VIDEOS/Astro_Menu_Art_Update_menu_loop.ogv")#preload("res://VIDEOS/Astro_Menu_Art_MENU-C.ogv")
	...
	videoMission = preload("res://VIDEOS/Astro_Menu_Art_Update_intro.ogv")#preload("res://VIDEOS/Astro_Menu_Art_MISSION.ogv")
